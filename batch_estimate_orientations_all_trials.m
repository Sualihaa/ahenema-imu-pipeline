...
for p = 1:length(participants)
    ...
    for tr = 1:length(trialFolders)
        ...
        try
            ...
            status = estimate_orientations_one_trial_function(syncFolder);
...
%% SAVE LOG
logFile = fullfile(batchLogFolder, 'Batch_Orientation_Log_MagOFF.csv');
writetable(OrientationLog, logFile);

fprintf('\n=====================================\n');
fprintf('BATCH ORIENTATION COMPLETE\n');
fprintf('=====================================\n');
